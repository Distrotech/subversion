...
svn_repos_notify_failure = _repos.svn_repos_notify_failure
...
class svn_repos_notify_t:
    ...
    __swig_setmethods__["err"] = _repos.svn_repos_notify_t_err_set
    __swig_getmethods__["err"] = _repos.svn_repos_notify_t_err_get
