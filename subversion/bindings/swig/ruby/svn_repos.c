...
/*@SWIG:/home/breser/wandisco/rm/1.9.0-rc1/prefix/share/swig/2.0.12/ruby/rubyprimtypes.swg,19,%ruby_aux_method@*/
...
SWIGINTERN VALUE
_wrap_svn_repos_notify_t_err_set(int argc, VALUE *argv, VALUE self) {
  struct svn_repos_notify_t *arg1 = (struct svn_repos_notify_t *) 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_svn_repos_notify_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "struct svn_repos_notify_t *","err", 1, self )); 
  }
  arg1 = (struct svn_repos_notify_t *)(argp1);
...
SWIGINTERN VALUE
_wrap_svn_repos_notify_t_err_get(int argc, VALUE *argv, VALUE self) {
  struct svn_repos_notify_t *arg1 = (struct svn_repos_notify_t *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  svn_error_t *result = 0 ;
...
_wrap_svn_repos_verify_fs3(int argc, VALUE *argv, VALUE self) {
  ...
  arg6 = RTEST(argv[5]);
  {
    ...
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), Ruby_Format_TypeError( "", "svn_repos_notify_func_t","svn_repos_verify_fs3", 7, argv[6] )); 
    }
  }
  res8 = SWIG_ConvertPtr(argv[7],SWIG_as_voidptrptr(&arg8), 0, 0);
  if (!SWIG_IsOK(res8)) {
    SWIG_exception_fail(SWIG_ArgError(res8), Ruby_Format_TypeError( "", "void *","svn_repos_verify_fs3", 8, argv[7] )); 
  }
  {
    int res = SWIG_ConvertFunctionPtr(argv[8], (void**)(&arg9), SWIGTYPE_p_f_p_void__p_svn_error_t);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), Ruby_Format_TypeError( "", "svn_cancel_func_t","svn_repos_verify_fs3", 9, argv[8] )); 
    }
  }
  res10 = SWIG_ConvertPtr(argv[9],SWIG_as_voidptrptr(&arg10), 0, 0);
  if (!SWIG_IsOK(res10)) {
    SWIG_exception_fail(SWIG_ArgError(res10), Ruby_Format_TypeError( "", "void *","svn_repos_verify_fs3", 10, argv[9] )); 
  }
  if (argc > 10) {
...
SWIGEXPORT void Init_repos(void) {
  ...
  rb_define_const(mRepos, "Svn_repos_notify_failure", SWIG_From_int((int)(svn_repos_notify_failure)));
  ...
  rb_define_method(SwigClassSvn_repos_notify_t.klass, "err=", _wrap_svn_repos_notify_t_err_set, -1);
  rb_define_method(SwigClassSvn_repos_notify_t.klass, "err", _wrap_svn_repos_notify_t_err_get, -1);
